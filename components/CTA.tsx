...
export function CTA() {
  return (
    <section id="contact" className="relative bg-surface py-28 md:py-36 overflow-hidden">
      <div
        aria-hidden
      ...
      <div className="relative max-w-3xl mx-auto px-5 md:px-8 text-center">
        <Reveal>
          <span className="font-mono text-xs tracking-[0.25em] text-blue-soft">LET'S BUILD</span>
          ...
          <p className="mt-6 text-muted text-base md:text-lg max-w-xl mx-auto">
            Tell us what you're building. We'll scope it, quote it, and if it's
            a fit, have your MVP live before the month is out.
          </p>
